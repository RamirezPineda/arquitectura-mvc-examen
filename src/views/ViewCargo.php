...
class ViewCargo
{
    ...
    public function mostrar(array $cargos): void
    {
        $title = 'Cargos de la iglesia';
        $tbody = $this->renderTableBody($cargos);
        include '../src/templates/cargos/index.html';
    }
}
