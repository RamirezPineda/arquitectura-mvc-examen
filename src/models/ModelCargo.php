...
class ModelCargo
{
  ...
  {
    return Sqlite::execSqlSelect('SELECT * FROM cargo;');
  }

  public function crear(): void
  {
    $sqlQueryInsert = "INSERT INTO cargo (nombre, descripcion)";
  ...
  {
    $sqlQueryUpdate = "UPDATE cargo SET nombre='%s', descripcion='%s' WHERE id=%s";
  ...
  {
    return Sqlite::execSql("DELETE FROM cargo WHERE id=$id");
  }
}
